// Minimalist product data grouped by category (same as script.js)
...
function renderCategoryProducts() {
  ...
  const cat = productCategories.find(c => c.name === catName);
  const title = document.getElementById('category-title');
  const sectionTitle = document.getElementById('category-section-title');
  if (!cat) {
    title.textContent = 'Category Not Found';
    sectionTitle.textContent = 'No Products';
    document.getElementById('category-products').innerHTML = '<p>No products found for this category.</p>';
    return;
  }
  title.textContent = cat.name;
  sectionTitle.textContent = cat.name + ' Products';
  const container = document.getElementById('category-products');
  container.innerHTML = cat.products.map(product => `
